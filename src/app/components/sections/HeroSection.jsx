...
const HeroSection = () => {
  ...
  return (
    <>
      {width < 768 && (
        <section className="h-full w-full bg-zinc-900 py-10 bg-inherit items-center space-y-8 md:space-y-0 px-6 md:px-0">
      ...
      {width >= 768 && (
        ...
        >
          ...
          >
            ...
            <div className="p-8">
              <p className="text-zinc-100 text-3xl md:text-5xl font-semibold">
                Nous créons des contenus à forte personnalité pour vous
                permettre d’exprimer la votre.
              </p>
            </div>
            <div className="relative aspect-square">
              <video className="object-cover" loop autoPlay="autoplay" muted>
